 ...
 * @author Annie&Teudis
 */
public class Lotes extends javax.swing.JDialog {

    /**
     * Creates new form Lotes
     * @param parent
     */
    public Lotes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         //Asigna un titulo a la barra de titulo
        setTitle("Listado de Lotes");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Lotes dialog = new Lotes(new javax.swing.JFrame(), true);
